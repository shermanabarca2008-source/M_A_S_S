...
Jakarta EE version and runtime choice (this sample assumes Java SE 25). Note, 
...
choice (this sample assumes Java SE 25) and 
...
```
./mvnw clean package
docker build -t M_A_S_S:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 9080:9080 M_A_S_S:v1
```
